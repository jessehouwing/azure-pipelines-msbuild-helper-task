...
// Source: https://raw.githubusercontent.com/Microsoft/vsts-tasks/master/definitions/vsts-task-lib.d.ts
declare module 'vso-task-lib' {

module 'vsts-task-lib/taskcommand' {
...
module 'vsts-task-lib/toolrunner' {
	import Q = require('q');
